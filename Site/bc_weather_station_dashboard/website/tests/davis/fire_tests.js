...
const { updateFFMC } = require('../../static/WidgetJavaScript/ffmc.js');
...
const { updateDMC } = require('../../static/WidgetJavaScript/dmc.js');
...
const { updateDC } = require('../../static/WidgetJavaScript/dc.js');
...
const { updateBUI } = require('../../static/WidgetJavaScript/bui.js');
...
const { updateDangerRating } = require('../../static/WidgetJavaScript/danger_rating.js');
