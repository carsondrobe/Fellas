...
const { updateFFMC } = require('../../static/widgetsJS/fire/ffmc.js');
...
const { updateDMC } = require('../../static/widgetsJS/fire/dmc.js');
...
const { updateDC } = require('../../static/widgetsJS/fire/dc.js');
...
const { updateISI } = require('../../static/widgetsJS/fire/isi.js');
...
const { updateBUI } = require('../../static/widgetsJS/fire/bui.js');
...
const { updateFWI } = require('../../static/widgetsJS/fire/fwi.js');
...
const { updateDangerRating } = require('../../static/widgetsJS/fire/danger_rating.js');
