...
station_data = pd.read_csv("https://raw.githubusercontent.com/carsondrobe/Fellas/25501b33a408282b39b1fb4008311f9b81ac92c0/Site/bc_weather_station_dashboard/website/data/BC_Wildfire_Active_Weather_Stations.csv", index_col=None, header=0)
station_data.head()
...
columns_we_need = ['X', 'Y', 'HOURLY_PRECIPITATION', 'HOURLY_TEMPERATURE', 'HOURLY_RELATIVE_HUMIDITY', 'HOURLY_WIND_SPEED', 'HOURLY_WIND_DIRECTION', 'HOURLY_WIND_GUST',]
...
# df_std = (features_df - train_mean) / train_std
# df_std = df_std.melt(var_name='Column', value_name='Normalized')
# plt.figure(figsize=(12, 6))
# ax = sns.violinplot(x='Column', y='Normalized', data=df_std)
# _ = ax.set_xticklabels(features_df.keys(), rotation=90)
#
# grouped = train_df.groupby(['X', 'Y'])
# array_of_dfs = [group for _, group in grouped]
...
columns_to_predict = ['HOURLY_PRECIPITATION', 'HOURLY_TEMPERATURE', 'HOURLY_RELATIVE_HUMIDITY', 'Wx', 'Wy', 'max Wx', 'max Wy']
# input_width = 7
# label_width = 1
# shift = 1
# w_generator = WindowGenerator(input_width=input_width, label_width=label_width, shift=shift,
...
#
# linear_model.save("weather_predictor.keras")
...
history = compile_and_fit(conv_model, conv_window, epochs=20, patience=20, learning_rate=0.0001)

plot_history(history)

# w_generator.plot(conv_model, plot_cols=['HOURLY_TEMPERATURE', 'HOURLY_RELATIVE_HUMIDITY', 'HOURLY_PRECIPITATION'])

conv_model.save("weather_predictor.h5")
